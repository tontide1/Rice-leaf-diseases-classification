"""Train ResNet18 Hybrid backbone on Paddy dataset."""
...
from src.models.backbones import ResNet18_Hybrid  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train ResNet18 Hybrid trên Paddy dataset")
    ...
    parser.add_argument("--reduction", type=int, default=32, help="Reduction ratio cho Coordinate Attention")
    ...
    # Tham số khác
    parser.add_argument("--model-name", type=str, default="ResNet18_Hybrid",
...
def main() -> None:
    ...
    # Khởi tạo model ResNet18_Hybrid
