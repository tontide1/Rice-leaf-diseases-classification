"""Train ResNet18 BoT backbone on Paddy dataset."""
...
from src.models.backbones import ResNet18_BoT  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train ResNet18 BoT trên Paddy dataset")
    ...
    # Tham số model
    parser.add_argument("--heads", type=int, default=4, help="Số attention heads trong BoT block")
    ...
    # Tham số khác
    parser.add_argument("--model-name", type=str, default="ResNet18_BoT",
