"""Train MobileNetV3 Small Vanilla (Baseline CNN) on Paddy dataset."""
...
from src.models.backbones import MobileNetV3_Small_Vanilla  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train MobileNetV3-Small Vanilla (Baseline CNN) on Paddy dataset"
    )
    ...
    parser.add_argument(
        "--model-name", 
        type=str, 
        default="MobileNetV3_Small_Vanilla",
...
def print_model_info(model, args):
    ...
    print("\n" + "="*70)
    print("MODEL ARCHITECTURE: MobileNetV3-Small Vanilla (Baseline CNN)")
    print("="*70)
    print(f"  Backbone:           MobileNetV3-Small (pretrained={args.pretrained})")
    print(f"  Attention:          None (Pure CNN Baseline)")
...
def main() -> None:
    ...
    model = MobileNetV3_Small_Vanilla(
